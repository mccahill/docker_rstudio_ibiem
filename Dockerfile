...
RUN DEBIAN_FRONTEND=noninteractive wget \
   ...
   https://mirrors.nics.utk.edu/cran/src/contrib/rlang_0.1.2.tar.gz \
   https://mirrors.nics.utk.edu/cran/src/contrib/tibble_1.3.4.tar.gz \
...
RUN DEBIAN_FRONTEND=noninteractive wget \
   https://mirrors.nics.utk.edu/cran/src/contrib/chron_2.3-51.tar.gz \
   https://mirrors.nics.utk.edu/cran/src/contrib/data.table_1.10.4-2.tar.gz \
   ...
   https://mirrors.nics.utk.edu/cran/src/contrib/tidyselect_0.2.2.tar.gz \
   https://mirrors.nics.utk.edu/cran/src/contrib/tidyr_0.7.1.tar.gz \
...
RUN cd /tmp && \
    ...
    $CONDA_DIR/bin/conda install python=2.7 qiime matplotlib=1.4.3 mock nose vsearch -c bioconda && \
